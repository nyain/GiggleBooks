...
<head>
    ...
    <title>Admin | GiggleBooks<</title> </head> <body>
            <!-- ============================================================== -->
            <!-- main wrapper -->
            <!-- ============================================================== -->
            <div class="dashboard-main-wrapper">
                ...
                <div class="dashboard-header">
                    <nav class="navbar navbar-expand-lg bg-white fixed-top">
                        <a class="navbar-brand" href="dashboard.php">GiggleBooks</a>
                        ...
                        <div class="container-fluid dashboard-content ">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <!-- <p><b>Toko Buku GiggleBooks</b> merupakan aplikasi Toko Buku berbasis
                                        ...
                                        <p><b>Aplikasi</b> ini menggunakan bahasa pemrograman server side (PHP) dan
                                            ...
                                            XAMPP, MySQL, Visual Studio Code, dan Google Chrome.</p> -->
                                    </div>
                                </div>
                            </div>
                        </div>
