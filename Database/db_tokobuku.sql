...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2022 at 04:45 AM
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `FK_user_customer` FOREIGN KEY (`id_customer`) REFERENCES `customer` (`id_customer`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
